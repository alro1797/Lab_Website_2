...
*/
	...
	function loadStatsPage(){
		...
		for(var l = 2; l < x.rows.length; l++){
			var a = x.rows[l].cells[2].innerHTML;
			var b = x.rows[l].cells[3].innerHTML;
			...
			if(a>b){
				...
				var win = x.rows[l].cells[1].innerHTML;
				diff++;
			}
			else{
				var win = "Tie";
			}
			x.rows[l].cells[4].innerHTML = win;
		}
		 
		document.getElementById("wins").innerHTML = sumVal;
		document.getElementById("losses").innerHTML = diff;
